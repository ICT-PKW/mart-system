...
function BillCancel({ close, cancelBill }) {
    ...
    return (
        <div className='fixed top-0 left-0 z-10 bg-black/25 w-full h-full flex justify-center items-center'>
            <div
                ...
                <h1 className="text-xl text-center font-semibold gap-2 group-hover:gap-4 transition-all duration-100">ยกเลิกบิล</h1>
                <hr className='my-2' />
                ...
                <div className='flex justify-center gap-2'>
                    ...
                    <button
                        type="button"
                        className='bg-red-500 rounded-lg py-2 px-4 text-white mt-2 inline-flex items-center gap-1 hover:gap-2 transition-all hover:bg-red-700 shadow-lg'
                        onClick={() => cancelBill(value)}
                    >
                        ยกเลิกบิล
                    </button>
                </div>
